...
describe('resolveAvailability — currently on leave', () => {
  it('sets activeBlock and returningOn', () => {
    ...
    // Thu 21 should be 'recovery' day [0].
